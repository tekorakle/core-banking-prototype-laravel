...
class DemoAIChatController extends Controller
{
     ...
     *         @OA\JsonContent(
     *             required={"message"},
     *             @OA\Property(property="message", type="string", maxLength=500, example="What is my account balance?")
     *         )
     *     ),
     *     @OA\Response(
     *         response=200,
     ...
     *             @OA\Property(property="agents_used", type="array", @OA\Items(type="string")),
