...
@section('title', 'Mobile Payments — Passkeys, P2P & Solana Wallets | ' . config('brand.name', 'Zelta'))

@section('seo')
    @include('partials.seo', [
        'title' => 'Mobile Payments — Passkeys, P2P & Solana Wallets | ' . config('brand.name', 'Zelta'),
