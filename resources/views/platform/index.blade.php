                ...
                <div class="grid lg:grid-cols-2 gap-12 items-center">
                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-3 gap-4 mt-12">
                            ...
                            <div>
                                <div class="text-2xl font-bold text-blue-400 code-font">56</div>
        ...
        <section id="architecture" class="py-20 bg-white">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mt-6">
                    <!-- ISO 20022 -->
                    <div class="bg-gradient-to-br from-blue-600 to-indigo-700 rounded-xl p-6 text-white relative overflow-hidden">
                        <div class="absolute top-2 right-2">
                            <span class="px-2 py-1 bg-green-400 text-green-900 rounded-full text-xs font-bold">LIVE</span>
                        </div>
                        <div class="w-12 h-12 bg-white/20 rounded-lg flex items-center justify-center mb-4">
                        ...
                        <h3 class="text-xl font-bold mb-2">ISO 20022</h3>
                        <p class="text-blue-100 text-sm mb-4">Standards-compliant messaging with pacs, pain, and camt message types</p>
                    ...
                    <div class="bg-gradient-to-br from-orange-500 to-amber-600 rounded-xl p-6 text-white relative overflow-hidden">
                        ...
                        <h3 class="text-xl font-bold mb-2">Payment Rails</h3>
                        <p class="text-orange-100 text-sm mb-4">ACH, Fedwire, RTP, FedNow, SEPA with intelligent rail routing</p>
                        <a href="{{ route('features') }}" class="text-white font-semibold hover:underline">Learn more &rarr;</a>
                    </div>

                    <!-- Open Banking -->
                    <div class="bg-gradient-to-br from-teal-500 to-emerald-600 rounded-xl p-6 text-white relative overflow-hidden">
                        <div class="absolute top-2 right-2">
                            <span class="px-2 py-1 bg-green-400 text-green-900 rounded-full text-xs font-bold">LIVE</span>
                        </div>
                        <div class="w-12 h-12 bg-white/20 rounded-lg flex items-center justify-center mb-4">
                        ...
                        <h3 class="text-xl font-bold mb-2">Open Banking</h3>
                        <p class="text-teal-100 text-sm mb-4">PSD2 consent lifecycle, AISP/PISP services, Berlin Group and UK adapters</p>
                        <a href="{{ route('features') }}" class="text-white font-semibold hover:underline">Learn more &rarr;</a>
                    </div>

                    <!-- Interledger -->
                    <div class="bg-gradient-to-br from-purple-500 to-violet-600 rounded-xl p-6 text-white relative overflow-hidden">
                        <div class="absolute top-2 right-2">
                            <span class="px-2 py-1 bg-green-400 text-green-900 rounded-full text-xs font-bold">LIVE</span>
                        </div>
                        <div class="w-12 h-12 bg-white/20 rounded-lg flex items-center justify-center mb-4">
                        ...
                        <h3 class="text-xl font-bold mb-2">Interledger</h3>
                        <p class="text-purple-100 text-sm mb-4">ILP connector, Open Payments (GNAP), cross-currency quotes</p>
                        <a href="{{ route('features') }}" class="text-white font-semibold hover:underline">Learn more &rarr;</a>
                    </div>

                    <!-- Ledger -->
                    <div class="bg-gradient-to-br from-slate-600 to-gray-800 rounded-xl p-6 text-white relative overflow-hidden">
                        <div class="absolute top-2 right-2">
                            <span class="px-2 py-1 bg-green-400 text-green-900 rounded-full text-xs font-bold">LIVE</span>
                        </div>
                        <div class="w-12 h-12 bg-white/20 rounded-lg flex items-center justify-center mb-4">
                        ...
                        <h3 class="text-xl font-bold mb-2">Double-Entry Ledger</h3>
                        <p class="text-gray-300 text-sm mb-4">Chart of accounts, journal entries, GL auto-posting, optional TigerBeetle driver</p>
                        <a href="{{ route('features') }}" class="text-white font-semibold hover:underline">Learn more &rarr;</a>
                    </div>
                    ...
                    <div class="bg-gradient-to-br from-green-500 to-emerald-600 rounded-xl p-6 text-white relative overflow-hidden">
                        ...
                        <h3 class="text-xl font-bold mb-2">Microfinance</h3>
                        <p class="text-green-100 text-sm mb-4">Group lending, IFRS provisioning, share accounts, teller ops, field officer tools</p>
                        <a href="{{ route('features') }}" class="text-white font-semibold hover:underline">Learn more &rarr;</a>
                    </div>
                </div>
