...
@section('seo')
    ...
    $faqData = [
        [
            ...
            'answer' => config('brand.name', 'Zelta') . ' v7.10.4 is a fully-featured open-source core banking platform with 56 domain modules. The public instance runs in sandbox mode with test data so you can explore every feature freely. No real money is processed in the sandbox environment.'
        ],
        [
                ...
                <div class="faq-item" data-category="platform">
                    ...
                    <div class="faq-answer px-6 py-4 bg-white rounded-b-lg">
                        <p class="text-slate-500">
                            {{ config('brand.name', 'Zelta') }} is a fully-featured open-source core banking platform at v7.10.4. The sandbox environment lets you:
                        </p>
