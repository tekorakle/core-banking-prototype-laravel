...
<div class="bg-foodo-surface-dark text-white p-3 flex flex-wrap items-center justify-between gap-3 text-xs border-b border-stone-800 shrink-0">
    <div class="flex items-center gap-4 lg:gap-6 flex-wrap">
        ...
        <div class="hidden sm:block h-4 w-px bg-stone-700"></div>
        <div>
            <span class="text-stone-400 mr-1">EBITDA</span>
            <span class="font-black text-emerald-400">&euro;304,369</span>
